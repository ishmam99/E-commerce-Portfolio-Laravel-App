        ...
        <div class="col-lg-5">
            <div class="card card-custom bg-gray-100 card-stretch gutter-b">
                ...
                <div class="card-body p-0 position-relative overflow-hidden">
                    <div id="kt_mixed_widget_1_chart" class="card-rounded-bottom bg-primary" style="height: 100px; min-height: 100px;">
                    </div>
                    <div class="card-spacer mt-n25">
                        <div class="row m-0">
                            <div class="col bg-light-warning px-6 py-8 rounded-xl mr-7 mb-7">
                                ...
                                <a href="#" class="text-warning font-weight-bold font-size-h6"></a>
                            </div>
                            <div class="col bg-light-primary px-6 py-8 rounded-xl mb-7">
                                ...
                                <a href="#" class="text-primary font-weight-bold font-size-h6 mt-2"></a>
                            </div>
                        </div>
                        <div class="row m-0">
                            <div class="col bg-light-danger px-6 py-8 rounded-xl mr-7 mb-7">
                                ...
                                <a href="#" class="text-danger font-weight-bold font-size-h6 mt-2"></a>
                            </div>
                            <div class="col bg-light-success px-6 py-8 rounded-xl mb-7">
                                ...
                                <a href="#" class="text-success font-weight-bold font-size-h6 mt-2"></a>
                            </div>
                        </div>
                    </div>
