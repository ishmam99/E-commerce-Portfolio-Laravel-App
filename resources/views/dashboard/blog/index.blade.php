  ...
  <div class="card card-custom">
    ...
    <div class="card-header flex-wrap border-0 pt-6 pb-0">
      <div class="card-title">
        <h3 class="card-label">Post List</h3>
      </div>
          ...
          <tbody>
            @foreach($blogs as $blog)
              <tr>
               ...
               <td><img src="{{setImage($blog->image)}}" sizes="50*50" alt=""></td>
                <td>{{ $blog->title }}</td>
                ...
                <td nowrap="nowrap">
                  <a href="{{ route('blog.edit', $blog->id) }}" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3">
                   ...
                   <a href="{{ route('blog.show', $blog->id) }}" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3">
                    <span class="svg-icon svg-icon-md svg-icon-primary">
                      <img src="https://img.icons8.com/office/16/000000/details-pane.png"/>
                    </span>
                  </a>
                  <form method="post" action="{{ route('blog.destroy', $blog->id) }}" class="d-inline-block">
                    @csrf
                    @method('DELETE')
