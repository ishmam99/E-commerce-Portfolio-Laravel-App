          ...
          <div class="col-xl-8">
            <div class="my-5">
              ...
              <div class="form-group row">
                ...
                <div class="col-md-9">
                  <input name="url" value="{{ old('url', $product->url) }}" id="url" class="form-control form-control-solid @error('url') is-invalid @enderror" type="text">
                  @error('url')
              ...
              <div class="form-group row">
                ...
                <div class="col-md-9">
                  <input name="da" value="{{ old('da', $product->da) }}" id="da" class="form-control form-control-solid @error('da') is-invalid @enderror" type="text">
                  @error('da')
                  <div class="text-danger">{{ $message }}</div>
                  @enderror
                </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-md-9">
                  <input name="pa" value="{{ old('pa', $product->pa) }}" id="pa" class="form-control form-control-solid @error('pa') is-invalid @enderror" type="text">
                  @error('pa')
                  <div class="text-danger">{{ $message }}</div>
                  @enderror
                </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-md-9">
                  <input name="dr" value="{{ old('dr', $product->dr) }}" id="dr" class="form-control form-control-solid @error('dr') is-invalid @enderror" type="text">
                  @error('dr')
                  <div class="text-danger">{{ $message }}</div>
                  @enderror
                </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-md-9">
                  <input name="cbd_casino" value="{{ old('cbd_casino', $product->cbd_casino) }}" id="cbd_casino" class="form-control form-control-solid @error('cbd_casino') is-invalid @enderror" type="text">
                  @error('cbd_casino')
                  <div class="text-danger">{{ $message }}</div>
                  @enderror
                </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-md-9">
                  <input name="language" value="{{ old('language', $product->language) }}" id="language" class="form-control form-control-solid @error('language') is-invalid @enderror" type="text">
                  @error('language')
                  <div class="text-danger">{{ $message }}</div>
                  @enderror
                </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-md-9">
                  <input name="monthly_traffic" value="{{ old('monthly_traffic', $product->monthly_traffic) }}" id="monthly_traffic" class="form-control form-control-solid @error('monthly_traffic') is-invalid @enderror" type="text">
              ...
              <div class="form-group row">
                ...
                <div class="col-md-9">
                  <input name="country" value="{{ old('country', $product->country) }}" id="country" class="form-control form-control-solid @error('country') is-invalid @enderror" type="text">
                  @error('country')
                  <div class="text-danger">{{ $message }}</div>
                  @enderror
                </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-md-9">
                  <input name="buyer_price" value="{{ old('buyer_price', $product->buyer_price) }}" id="buyer_price" class="form-control form-control-solid @error('buyer_price') is-invalid @enderror" type="text">
                  @error('buyer_price')
                  <div class="text-danger">{{ $message }}</div>
                  @enderror
                </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-md-9">
                  <input name="reseller_price" value="{{ old('reseller_price', $product->reseller_price) }}" id="reseller_price" class="form-control form-control-solid @error('reseller_price') is-invalid @enderror" type="text">
              ...
              <div class="form-group row">
                ...
                <div class="col-md-9">
                  <input name="ads_from" id="ads_from" value="{{ old('ads_from', $product->ads_from) }}" class="form-control form-control-solid @error('ads_from') is-invalid @enderror" type="text">
                  @error('ads_from')
                  <div class="text-danger">{{ $message }}</div>
                  @enderror
                </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-lg-9">
                  <select class="form-control select2-withTag" id="tag_id" multiple name="tag_id[]">
                    @foreach ($tags as $tag)
                      <option value="{{ $tag->id }}" {{ $product->Tags->contains($tag->id) ? 'selected' : null }}>{{ $tag->name }}</option>
                    @endforeach
                  </select>
                  @error('tag_id')
              ...
              <div class="form-group row">
                ...
                <div class="col-lg-4 col-md-9 col-sm-12">
                  <input name="last_active" value="{{ old('last_active', $product->last_active) }}" id="last_active" type="date" class="form-control" placeholder="Select last_active"/>
                  @error('last_active')
                  <span class="text-danger"><strong>{{ $message }}</strong></span>
                  @enderror
                </div>
