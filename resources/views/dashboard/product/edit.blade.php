            ...
            <div class="my-5">
              ...
              <div class="col-lg-4 col-xl-4"> 
                ...
                <div class="image-input image-input-outline image-input" id="kt_image_3">
                  <div class="image-input-wrapper" style="width: 120px; background-position: center; background-image: url({{setImage($product->image_one)}})"></div>
             ...
             <div class="col-lg-4 col-xl-4"> 
                ...
                <div class="image-input image-input-outline image-input" id="kt_image_4">
                  <div class="image-input-wrapper" style="width: 120px; background-position: center; background-image: url({{setImage($product->image_two)}})"></div>
                  <label class="btn btn-xs btn-icon btn-circle btn-white btn-hover-text-primary btn-shadow" data-action="change" data-toggle="tooltip" title="" data-original-title="Change avatar">
                    <i class="fa fa-pen icon-sm text-muted"></i>
                ...
                <div class="image-input image-input-outline image-input" id="kt_image_5">
                  <div class="image-input-wrapper" style="width: 120px; background-position: center; background-image: url({{setImage($product->image_three)}})"></div>
                  <label class="btn btn-xs btn-icon btn-circle btn-white btn-hover-text-primary btn-shadow" data-action="change" data-toggle="tooltip" title="" data-original-title="Change avatar">
                    <i class="fa fa-pen icon-sm text-muted"></i>
              ...
              <div class="form-group row">
                ...
                <div class="col-md-10">
                  <input name="name" id="name" value="{{ old('name', $product->name) }}" class="form-control form-control-solid @error('name') is-invalid @enderror" type="text">
                  @error('name')
              ...
              <div class="form-group row">
                <label class="col-md-3 col-form-label" for="productCategory">Sub Category&nbsp;<span class="text-danger">*</span></label>
                <div class="col-md-9">
                  <div class="form-group">
                    <select class="form-control select2" name="sub_category_id" id="">
                      @foreach(App\Models\SubCategory::all() as $productCategory)
                        <option value="{{ $productCategory->id}}" {{ $product->sub_category_id==($productCategory->id) ? 'selected' : null }}>{{ $productCategory->name }}</option>
                      @endforeach
                    </select>
                  </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-md-10">
                  <textarea name="details" id="details" class="form-control form-control-solid @error('details') is-invalid @enderror">{{ old('details', $product->details) }}</textarea>
                  @error('details')
                  <div class="text-danger">{{ $message }}</div>
                  @enderror
                </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-md-10">
                  ...
                  <label>
                    <input type="checkbox" {{ $product->status == 0 ? 'checked' : '' }} value="1" name="status"/>
                    <span></span>
                  </label>
                </span>
                </div>
