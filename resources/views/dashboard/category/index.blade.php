          ...
          <tbody>
            @foreach($categories as $category)
              <tr>
                ...
                <td>{{ $category->name }}</td>
                  <td> <img style="width: 150px;" src="{{ setImage($category->image) }}" alt=""></td>
                <td nowrap="nowrap">
                  <a href="{{route('category.edit',$category->id)}}" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <label for="name" class="form-control">Category Name</label>
       <input type="text" class="form-control" name="name" id="name">
      
       <div class="col-lg-4 col-xl-4"> 
                <label class="col-xl-6 col-form-label">Category Photo</label>
