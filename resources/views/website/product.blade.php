                ...
                <div class="row">
                        ...
                        <div class="product-default">
                            <figure>
                                <a href="{{route('show_product',$product->id)}}">
                                    <img src="{{setImage($product->image_one)}}" width="100%" height="220px" alt="product" />
                                    <img src="{{setImage($product->image_two)}}" width="220" height="220" alt="product" />
                                </a>
                            ...
                            <div class="product-details">
                                ...
                                <h3 class="product-title"> <a href="{{route('show_product',$product->id)}}">{{$product->name}}</a>
                                </h3>
                    ...
                    {{-- <div class="col-6 col-sm-4 col-md-3 col-xl-5col">
                        <div class="product-default">
                            <figure>
                                <a href="product.html">
                                    <img src="assets/images/products/product-2.jpg" width="220" height="220" alt="product" />
                                    <img src="assets/images/products/product-2-2.jpg" width="220" height="220" alt="product" />
                                </a>
                            </figure>
                    ...
                    {{-- <div class="col-6 col-sm-4 col-md-3 col-xl-5col">
                        <div class="product-default">
                            <figure>
                                <a href="product.html">
                                    <img src="assets/images/products/product-3.jpg" width="220" height="220" alt="product" />
                                    <img src="assets/images/products/product-3-2.jpg" width="220" height="220" alt="product" />
                                </a>
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-xl-5col">
                        <div class="product-default">
                            <figure>
                                <a href="product.html">
                                    <img src="assets/images/products/product-4.jpg" width="220" height="220" alt="product" />
                                    <img src="assets/images/products/product-4-2.jpg" width="220" height="220" alt="product">
                                </a>
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-xl-5col">
                        <div class="product-default">
                            <figure>
                                <a href="product.html">
                                    <img src="assets/images/products/product-5.jpg" width="220" height="220" alt="product" />
                                    <img src="assets/images/products/product-5-2.jpg" width="220" height="220" alt="product" />
                                </a>
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-xl-5col">
                        <div class="product-default">
                            <figure>
                                <a href="product.html">
                                    <img src="assets/images/products/product-12.jpg" width="220" height="220" alt="product" />
                                    <img src="assets/images/products/product-12-2.jpg" width="220" height="220" alt="product" />
                                </a>
